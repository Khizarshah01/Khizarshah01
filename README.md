...
<p align-item= "center" >Greetings and welcome to my GitHub profile! As a skilled Full-Stack Web Developer, I am passionate about exploring the latest technology and using my knowledge to create innovative solutions. With expertise in programming languages such as Java, Python, C++, and JavaScript, as well as experience in scripting and server management, I am constantly expanding my skills to deliver exceptional results. In addition to my work on challenging web applications, I enjoy giving back to the open-source community and collaborating with others to enhance the tools and resources available to developers worldwide. Whether I'm working on personal projects or collaborating with a team, I approach every challenge with dedication, creativity, and a strong commitment to excellence. I'm thrilled to share my journey with you and connect with other professionals who share my passion for innovation and quality. Thank you for taking the time to learn more about me, and I look forward to working with you!</p>
